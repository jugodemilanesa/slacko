...
<div class="flex h-screen overflow-hidden bg-surface">
	...
	<div class="flex-1 flex flex-col min-w-0">
		<!-- Header -->
		<header class="bg-surface-card border-b border-bot-border px-6 py-3 flex items-center gap-4 shrink-0">
			<button
